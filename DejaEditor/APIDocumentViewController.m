...
#import "APIClassViewController.h"

@interface APIDocumentViewController () <UISearchBarDelegate>

@property(nonatomic, retain)id<ScriptAPIDocument> APIDocument;
...
@implementation APIDocumentViewController
...
- (id)init
{
    ...
    self.APIDocument = [ScriptAPIDocumentFactory scriptAPIDocument];
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    APIClassViewController *classVC = [[[APIClassViewController alloc] initWithClassName:className
